...
for i = 1960:2009
    for j = 1:r1
        if (strcmp(state(j),'TX') && (time(j-1)==i) && strcmp(msn(j),'NGMPB'))
...
for i = 1960:2009
    for j = 1:r1
        if (strcmp(state(j),'TX') && (time(j-1)==i) && strcmp(msn(j),'PAPRB'))
...
for i = 1960:2009
    for j = 1:r1
        if (strcmp(state(j),'TX') && (time(j-1)==i) && strcmp(msn(j),'CLPRB'))
...
for i = 1960:2009
    for j = 1:r1
        if (strcmp(state(j),'TX') && (time(j-1)==i) && strcmp(msn(j),'TEPRB'))
